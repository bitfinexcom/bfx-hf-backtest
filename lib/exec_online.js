...
const execOnline = async (strategies = [], args = {}) => {
  ...
  const btStates = strategies.map((strategy, i) => {
  ...
  const btMessages = []
  const startProcessing = async () => processMessages()
