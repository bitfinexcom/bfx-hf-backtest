 ...
 * console.
 *
 * @memberof module:bfx-hf-backtest
 *
 * @param {module:bfx-hf-strategy.StrategyState[]} strategies - strategies
 ...
 * @param {string|string[]} [args.candleFields] - data to include on candle
 *   objects, default all fields
 * @param {string|string[]} [args.tradeFields] - data to include on trade
 *   objects, default all fields
 */
